...
<table class="form-table">
	<tbody>
		<tr valign="top">
			<th scope="row"><label for="modulo_venda_cat">Categoria</label></th>
			<td>
			<?php wp_dropdown_categories($modulo_cat_dropdown); ?>
			<br />
    ...
    <tr valign="top">
    <th scope="row">
    <label for="modulo_preco">Preço:</label>
    </th>
    <td>
	<input type="text" class="code" size="10" name="modulo_preco" value="<?php echo $modulo_preco; ?>" />
    <br/>
    Valor de cada mercadoria nesta categoria. <em>Ex:</em> 12.00
    </td>
    </tr>
    <tr valign="top">
    <th scope="row">
    ...
    <br/>
    <input type="checkbox" name="modulo_entrega_pac" value="true" <?php echo $modulo_entrega_pac_checked; ?> />
    <label for="modulo_entrega_correios">Pac</label>
    <br/>
    <input type="checkbox" name="modulo_entrega_gratis" value="true" <?php echo $modulo_entrega_gratis_checked; ?>  />
    <label for="modulo_entrega_correios">Gratis</label>
    <br/>
    <input type="checkbox" name="modulo_entrega_trans" value="true" <?php echo $modulo_entrega_trans_checked; ?>  />
	<label for="modulo_entrega_trans">Transferência Bancária</label>
    <p>Habilitar formas de envio. Lembre-se que é necessário configurar nas preferências web e frete do pagseguro para sedex e PAC</p>
    </td>
    </tr>
    <tr valign="top">
    <th scope="row">
    <label for="modulo_peso">Peso:</label>
    </th>
    <td>
	<input type="text" class="code" size="10" name="modulo_peso" value="<?php echo $modulo_peso; ?>" />
    <br/>
    Peso do produto em gramas. <em>Ex:</em> 1000 para 1kg
    </td>
    </tr>
    </tbody>
    </table>
